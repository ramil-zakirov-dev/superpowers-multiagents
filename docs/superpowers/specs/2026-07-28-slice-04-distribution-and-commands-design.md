...
| Situation | Behaviour |
| :--- | :--- |
| Command invoked with no argument | `$1` substitutes empty; the orchestrator is called with `--file ""` and refuses. Fail-closed, with a message naming the missing file. |
